...
function cpotheme_theme_layout($data){ 
	...
	//add_action('cpotheme_after_main', 'cpotheme_home_features');
	add_action('cpotheme_before_main', 'cpotheme_home_portfolio');
	add_action('cpotheme_before_main', 'cpotheme_home_services');
	//add_action('cpotheme_after_main', 'cpotheme_home_tagline');
	//add_action('cpotheme_after_main', 'cpotheme_home_testimonials');
	//add_action('cpotheme_after_main', 'cpotheme_home_clients');
	//add_action('cpotheme_after_main', 'cpotheme_home_team');
